...
object BuildSettings {
  val buildVersion = "0.11.0-play-2.3-SNAPSHOT"
  ...
  lazy val reactivemongo = Project(
    ...
    settings = buildSettings ++ Seq(
      ...
      libraryDependencies ++= Seq(
        "org.reactivemongo" %% "reactivemongo" % "0.11.0-akka-2.3-SNAPSHOT" cross CrossVersion.binary,
        "com.typesafe.play" %% "play" % "2.3-M1" % "provided" cross CrossVersion.binary,
        "com.typesafe.play" %% "play-test" % "2.3-M1" % "test" cross CrossVersion.binary,
